...
from crisiscoach.api.routes import chat, checkin, plan, auth, profile, goal_plan, daily_log, interviews, dashboard, intake
...
async def lifespan(app: FastAPI):
    from crisiscoach.ingestion.curriculum_db import ingest_seed_data
    try:
