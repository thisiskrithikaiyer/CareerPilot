...
from crisiscoach.eval.evaluators.similarity import score_response
...
def _make_state(input_text: str, phase: str = "intake", extra: dict | None = None) -> CrisisCoachState:
    base: CrisisCoachState = {
